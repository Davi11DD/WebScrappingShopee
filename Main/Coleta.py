...
class Coletar :
    def __init__(self, nomeProduto, driver, url) :
        ...
        while True :
            ...
            Grade     = WebDriverWait( driver , 11 ).until(EC.presence_of_element_located(      (By.XPATH, '//*[@id="main"]/div/div[2]/div/div/div[2]/div[3]/div[2]'         ) ) )
            Produtos  = WebDriverWait( Grade  , 11 ).until(EC.presence_of_all_elements_located( (By.CSS_SELECTOR, '.shopee-search-item-result__item'              ) ) )

            print(f'\n\n\n\033[1;32mProdutos encontrados: {len(Produtos)}\033[m')
            ...
            for enum, produto in enumerate(Produtos) : 
                ...
                try:
                    ...
                    nome = '\033[1;31m NOME NÂO FOI POSSÍVEL COLETAR\033[m'
